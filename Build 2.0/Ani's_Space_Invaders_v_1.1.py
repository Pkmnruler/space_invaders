...
class	playfield:
	def __init__(self,mapfile):
		...
		if f:
			...
			print("size = " + repr(self.mapxsz) + "," + repr(self.mapysz))
			self.tiles = []
...
def	canvas_greet():
	...
	tmp = "Last: " + repr(STATE.score) + cheatarray[STATE.cheating] + " --- High: " + repr(STATE.highscore)
...
def	canvas_playing():
	...
	VGAPRN.printf( 5, 5, repr(STATE.score));
